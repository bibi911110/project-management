    ...
    return (
        <>
            ...
            <Menu fixed="top" inverted>
                <Menu.Item as={Link} to={routes['HOME']} active={pathname === routes['HOME']} header>
                    Project Management
                </Menu.Item>
                <Menu.Item as={Link} to={routes['YOUR_WORK']} active={pathname === routes['YOUR_WORK']}>
                    Your work
                </Menu.Item>
                <Dropdown item text="Projects">
                    <Dropdown.Menu>
                        <Dropdown.Item as={Link} to={routes['PROJECTS']} active={pathname === routes['PROJECTS']}>
                            View all projects
                        </Dropdown.Item>
                        <Dropdown.Item onClick={() => setProjectOpen(!isProjectOpen)}>Create project</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                <Menu.Item as={Link} to={routes['DASHBOARDS']} active={pathname === routes['DASHBOARDS']}>
                    Dashboards
                </Menu.Item>
                <Menu.Item as={Link} to={routes['PEOPLE']} active={pathname === routes['PEOPLE']}>
                    People
                </Menu.Item>

                <Button color="blue" size="medium" onClick={() => setIssueOpen(!isIssueOpen)}>
                    Create
                </Button>
