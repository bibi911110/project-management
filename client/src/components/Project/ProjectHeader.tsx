...
import { deleteProject as deleteProjectAPI, Project } from '../../utils/API/project_API';
        ...
        <>
            ...
            <div className="project-header">
                ...
                <div className="right">
                    ...
                    <Dropdown
                        icon={null}
                        trigger={<Icon name="ellipsis horizontal" size="big" style={{ lineHeight: 'unset' }} />}
                        pointing="top right"
                    >
                        <Dropdown.Menu>
                            <Dropdown.Item text="Board Settings" />
                            <Dropdown.Item text="Create Board" />
                            <Dropdown.Item text="Delete Board" onClick={() => setOpen(true)} />
                        </Dropdown.Menu>
                    </Dropdown>
                </div>
            </div>
