...
export const createIssueType = async (issuetype: Partial<IssueType>): Promise<CreateIssueType> => {
    try {
...
export const updateIssueType = async (id: string, issuetype: Partial<IssueType>): Promise<UpdateIssueType> => {
    try {
