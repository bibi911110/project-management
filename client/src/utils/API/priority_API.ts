...
export const createPriority = async (priority: Partial<Priority>): Promise<CreatePriority> => {
    try {
...
export const updatePriority = async (id: string, priority: Partial<Priority>): Promise<UpdatePriority> => {
    try {
