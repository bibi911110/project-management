...
export const createProject = async (project: Partial<Project>): Promise<CreateProject> => {
    try {
...
export const updateProject = async (id: string, project: Partial<Project>): Promise<UpdateProject> => {
    try {
