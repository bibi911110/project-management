...
export const createIssue = async (issue: Partial<Issue>): Promise<CreateIssue> => {
    try {
...
export const getIssuesByProjectId = async (projectId: string): Promise<GetIssues> => {
    try {
...
export const updateIssue = async (id: string, issue: Partial<Issue>): Promise<UpdateIssue> => {
    try {
