...
export const updateRoom = async (roomId: string, roomData: Partial<Room>): Promise<UpdateRoom> => {
    try {
...
export const deleteMessage = async (messageId: string): Promise<DeleteMessage> => {
    try {
...
export const updateMessage = async (messageId: string, messageData: Partial<Message>): Promise<UpdateMessage> => {
    try {
...
type MessageData = Omit<Message, '_id' | 'isEdited' | '__v' | 'createdAt' | 'updatedAt'>;
...
export const createMessage = async (messageData: MessageData): Promise<CreateMessage> => {
    try {
