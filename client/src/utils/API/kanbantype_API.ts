...
export const createKanbanType = async (kanbantype: Partial<KanbanType>): Promise<CreateKanbanType> => {
    try {
...
export const updateKanbanType = async (id: string, priority: Partial<KanbanType>): Promise<UpdateKanbanType> => {
    try {
...
export const deleteKanbanType = async (id: string): Promise<DeleteKanbanType> => {
    try {
