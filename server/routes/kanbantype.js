...
router.put('/kanbantype/:id', verifyToken, KanbanTypeController.updateKanbanType);
router.delete('/kanbantype/:id', verifyToken, KanbanTypeController.deleteKanbanType);
router.get('/kanbantype/:id', verifyToken, KanbanTypeController.getKanbanTypeById);
